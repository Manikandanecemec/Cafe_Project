...
const MyOrderTab = ({ navigation }) => {
                    ...
                    <tr>
                      <td>
                        <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                          <tbody>
                            <tr>
                              <td align="left"> <img src="https://firebasestorage.googleapis.com/v0/b/cafe-b2e32.appspot.com/o/ic_launcher.png?alt=media&token=2bedb1c8-cdf8-497e-aadf-5b1afa9d8d23" width="32" height="32" alt="logo" border="0" /></td>
                            </tr>
                            <tr class="hiddenMobile">
                              <td height="40"></td>
                            </tr>
  ...
  `
    ...
    console.log("pdfdata" + data[0].orderBy);
    if (await isPermitted()) {
      let options = {
        //Content to print
        html: htmlstring,
